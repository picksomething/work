...
public class MinesweeperGame extends Activity
{
	...
	private TableLayout mineField; // 添加地雷到表格布局上

	private Block blocks[][]; // 地雷区	
	private int blockDimension = 24; // 方格宽度
	private int blockPadding = 2; // 两个方格的距离
	...
	private boolean isTimerStarted; // 时间是否已经开始
	private boolean areMinesSet; // 检查是否已经设置地雷	
	private boolean isGameOver;
	private int minesToFind; // 发现的地雷数
